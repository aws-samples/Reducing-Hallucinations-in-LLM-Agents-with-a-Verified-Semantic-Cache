...
class AgentsForAmazonBedrock:
    ...
    def delete_agent(self, agent_name: str, delete_role_flag: bool = True) -> None:
        ...
        if delete_role_flag:
            ...
            except self._iam_client.exceptions.NoSuchEntityException as e:
                print(
                    f"Error when detaching AmazonBedrockFullAccess policy from role: {_agent_role_name}\n{e}"
                )
    ...
    def _create_agent_role(
        ...
        # Create the IAM role with Bedrock as the trusted entity
        _assume_role_policy_document = {
            "Version": "2012-10-17",
            "Statement": [
                {
        ...
        # Attach the AmazonBedrockFullAccess managed policy to the role
        self._iam_client.attach_role_policy(
            RoleName=_agent_role_name,
            PolicyArn="arn:aws:iam::aws:policy/AmazonBedrockFullAccess",
        )
